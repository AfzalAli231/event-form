              ...
              >
                <div style={{ width: "30%" }}>
                  <TextField
                    ...
                    error={
                      formik.touched.projectorNeeded &&
                      Boolean(formik.errors.projectorNeeded)
                    }
                    helperText={
                      formik.touched.projectorNeeded &&
                      formik.errors.projectorNeeded
                    }
                    style={{
                ...
                <div style={{ width: "30%" }}>
                  <TextField
                    ...
                    error={
                      formik.touched.projectorQuantityFor &&
                      Boolean(formik.errors.projectorQuantityFor)
                    }
                    helperText={
                      formik.touched.projectorQuantityFor &&
                      formik.errors.projectorQuantityFor
                    }
                    style={{
                      backgroundColor: "#F5F5F5",
                      width: "100%",
                ...
                <div style={{ width: "30%" }}>
                  <TextField
                    ...
                    error={
                      formik.touched.projectorSizeFor &&
                      Boolean(formik.errors.projectorSizeFor)
                    }
                    helperText={
                      formik.touched.projectorSizeFor &&
                      formik.errors.projectorSizeFor
                    }
                    style={{
                      backgroundColor: "#F5F5F5",
                      width: "100%",
              ...
              >
                <div style={{ width: "30%" }}>
                  <TextField
                    ...
                    error={
                      formik.touched.ledNeeded &&
                      Boolean(formik.errors.ledNeeded)
                    }
                    helperText={
                      formik.touched.ledNeeded && formik.errors.ledNeeded
                    }
                    style={{
                      backgroundColor: "#F5F5F5",
                      width: "100%",
                ...
                <div style={{ width: "30%" }}>
                  <TextField
                    ...
                    error={
                      formik.touched.ledSizeFor &&
                      Boolean(formik.errors.ledSizeFor)
                    }
                    helperText={
                      formik.touched.ledSizeFor && formik.errors.ledSizeFor
                    }
                    style={{
                      backgroundColor: "#F5F5F5",
                      width: "100%",
                ...
                <div style={{ width: "30%" }}>
                  <TextField
                    ...
                    error={
                      formik.touched.ledQty && Boolean(formik.errors.ledQty)
                    }
              ...
              >
                <div style={{ width: "30%" }}>
                  <TextField
                    ...
                    error={
                      formik.touched.smdPlasmaNeededfor &&
                      Boolean(formik.errors.smdPlasmaNeededfor)
                    }
                    helperText={
                      formik.touched.smdPlasmaNeededfor &&
                      formik.errors.smdPlasmaNeededfor
                    }
                    style={{
                      backgroundColor: "#F5F5F5",
                      width: "100%",
                ...
                <div style={{ width: "30%" }}>
                  <TextField
                    ...
                    error={
                      formik.touched.smdPlasmaSizee &&
                      Boolean(formik.errors.smdPlasmaSizee)
                    }
                    helperText={
                      formik.touched.smdPlasmaSizee &&
                      formik.errors.smdPlasmaSizee
                    }
                    style={{
                      backgroundColor: "#F5F5F5",
                      width: "100%",
                ...
                <div style={{ width: "30%" }}>
                  <TextField
                    ...
                    error={
                      formik.touched.smdPlasmaQty &&
                      Boolean(formik.errors.smdPlasmaQty)
                    }
                    helperText={
                      formik.touched.smdPlasmaQty && formik.errors.smdPlasmaQty
                    }
                    style={{
                      backgroundColor: "#F5F5F5",
                      width: "100%",
